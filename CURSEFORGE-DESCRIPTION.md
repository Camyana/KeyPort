...
**Party, Guild, Alts and Friends tabs**, so you can see what your guildmates
are carrying, which of your own characters is holding the good key, and what
your Battle.net friends have (greyed out once the data is a week old), a **Mythic+ score** column, and a resize grip in the bottom right: taller
